...
const CTA: React.FC = () => {
    ...
    return (
        <section className='bg-base mt-7 mb-10' >
            <div className='bg-gradient-to-r from-black to-slate-900 pb-24 pt-16 px-8 max-w-sm md:max-w-5xl mx-auto flex flex-col items-center gap-8 md:gap-12 border border-gray-400 rounded-3xl'>
